...
function preload ()
{
    ...
    //load sounds
    this.load.audio('switch', 'https://dl.dropboxusercontent.com/s/ai40u3cfe8rvael/switch.mp3');
    this.load.audio('macSd', 'https://dl.dropboxusercontent.com/s/bjm09vfn9xrzo9a/macSd.wav');
    this.load.audio('hrtSd', 'https://dl.dropboxusercontent.com/s/mzkiwu29sz89km6/hrtSd.wav')
    this.load.audio('brnSd', 'https://dl.dropboxusercontent.com/s/bqu72rnfvo13o0s/brnSd.wav');
    this.load.audio('eyeSd', 'https://dl.dropboxusercontent.com/s/hkumqnosomc7di9/eyeSd.wav');
    this.load.audio('smkSd', 'https://dl.dropboxusercontent.com/s/x5f3ecsxnph3g56/smkSd.wav');
    this.load.audio('crtSd', 'https://dl.dropboxusercontent.com/s/2g4uhc52x215e9q/crtSd.wav');
    this.load.audio('crtSd2', 'https://dl.dropboxusercontent.com/s/07b2pxm5amq9dy1/crtSd2.wav');
    this.load.audio('gunSd', 'https://dl.dropboxusercontent.com/s/k4mvrcitbm1k7q9/gunSd.wav');
    this.load.audio('tvsSd', 'https://dl.dropboxusercontent.com/s/otkk079r4s9gv7s/tvsSd.wav');
    this.load.audio('tvsSd2', 'https://dl.dropboxusercontent.com/s/7nqhw17sbrmy8h8/tvsSd2.wav');
    this.load.audio('tubSd', 'https://dl.dropboxusercontent.com/s/n7i7scnalp6traz/tubSd.wav');
    this.load.audio('tubSd2', 'https://dl.dropboxusercontent.com/s/hnk9y2ezbkew1zy/tubSd2.wav');
    this.load.audio('porSd', 'https://dl.dropboxusercontent.com/s/3sgjwmf42opg0pi/porSd.wav');
    this.load.audio('porSd2', 'https://dl.dropboxusercontent.com/s/46rwf9ylr8as7tz/porSd2.wav');
    this.load.audio('porSd3', 'https://dl.dropboxusercontent.com/s/79aa7exgkmfcrnc/porSd3.wav');
